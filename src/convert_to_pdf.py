...
def get_paths(namespace: str, pdf_file_name: str):
    ...
    source_pdf_filepath = f'{config.paths["source_documents"]}/{namespace}/{pdf_file_name}'
    ...
    return source_pdf_filepath, processed_pdf_dir, processed_pdf_filepath, failed_documents_filepath
